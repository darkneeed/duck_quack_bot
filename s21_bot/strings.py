...
PEER_CARD_PREVIEW_HEADER = "🪪 <b>Профиль сообщества</b>"
PEER_CARD_SECTION_HEADER = "🪪 <b>Карточка сообщества</b>"
PEER_CARD_PHOTO_YES = "🖼 <b>Фото:</b> добавлено"
PEER_CARD_PHOTO_NO = "🖼 <b>Фото:</b> не добавлено"
PEER_CARD_PENDING_PHOTO = "⏳ <b>Фото:</b> новая версия на модерации"
PEER_CARD_PENDING_COMMENT = "⏳ <b>Комментарий:</b> новая версия на модерации"
PEER_CARD_COMMENT = "💭 <b>Комментарий:</b> {comment}"
PEER_CARD_CONTACT_PREFERRED = "📡 <b>Предпочитает связь:</b> {contact}"
PEER_CARD_CONTACT_TELEGRAM = "💬 <b>Telegram:</b> {value}"
PEER_CARD_CONTACT_ROCKET = "🚀 <b>Rocket.Chat:</b> {value}"
PEER_CARD_CONTACT_MAX = "🔗 <b>MAX:</b> {value}"
PEER_CARD_CONTACT_NONE = "не указан"
PEER_CARD_MAX_NONE = "не указана"
PEER_CARD_EMPTY = "🪪 Карточка пока пустая. Добавьте фото, комментарий или выберите удобный способ связи."
PEER_CARD_USAGE = "Использование: <code>/пир логин</code>\nНапример: <code>/пир kylaknap</code>"
PEER_CARD_NOT_FOUND = "📭 Участник с логином <code>{login}</code> не найден."
PEER_CARD_EDIT_PHOTO_PROMPT = (
    "📷 Фото отправится на модерацию перед публикацией.\n\n"
    "Требования:\n"
    "• на фото должен быть только пир\n"
    "• это должен быть именно он\n"
    "• лицо должно быть хорошо видно\n\n"
    "Отправьте фото. Для отмены используйте /cancel или кнопку ниже."
)
PEER_CARD_EDIT_COMMENT_PROMPT = (
    "💬 Комментарий отправится на модерацию перед публикацией.\n\n"
    "Не используйте:\n"
    "• мат\n"
    "• текст, не соответствующий правилам Школы 21\n"
    "• личную информацию\n\n"
    "Отправьте комментарий до 500 символов. Для отмены используйте /cancel или кнопку ниже."
)
PEER_CARD_PHOTO_SAVED = "✅ Фото отправлено на модерацию. После одобрения оно появится в карточке."
PEER_CARD_PHOTO_REMOVED = "🗑 Фото карточки удалено."
PEER_CARD_PHOTO_EXPECTED = "❌ Нужна именно фотография."
PEER_CARD_COMMENT_SAVED = "✅ Комментарий отправлен на модерацию. После одобрения он появится в карточке."
PEER_CARD_COMMENT_REMOVED = "🗑 Комментарий карточки удалён."
PEER_CARD_EDIT_CANCELLED = "ℹ️ Редактирование карточки отменено."
PEER_CARD_CONTACT_PROMPT = "📡 Выберите приоритетный способ связи."
PEER_CARD_CONTACT_SAVED = "✅ Предпочтительный способ связи обновлён."
PEER_CARD_MAX_REQUIRED = "Сначала укажите ссылку на профиль MAX."
PEER_CARD_MAX_LINK_PROMPT = "🔗 Отправьте полную ссылку на профиль MAX.\nНапример: <code>https://max.ru/u/username</code>\n\nДля отмены используйте /cancel или кнопку ниже."
PEER_CARD_MAX_LINK_INVALID = "❌ Нужна полная ссылка, начинающаяся с http:// или https://."
PEER_CARD_MAX_LINK_SAVED = "✅ Ссылка на профиль MAX обновлена."
PEER_CARD_BTN_EDIT_PHOTO = "📷 Изменить фото"
PEER_CARD_BTN_EDIT_COMMENT = "💬 Изменить комментарий"
PEER_CARD_BTN_CONTACT = "📡 Связь"
PEER_CARD_BTN_EDIT_MAX_LINK = "🔗 Ссылка MAX"
PEER_CARD_BTN_DELETE_PHOTO = "🗑 Удалить фото"
PEER_CARD_BTN_DELETE_COMMENT = "🧹 Удалить комментарий"
PEER_CARD_BTN_BACK = "⬅️ Назад"
PEER_CARD_BTN_CANCEL = "❌ Отмена"
PEER_CARD_BTN_CONTACT_TG = "Telegram"
PEER_CARD_BTN_CONTACT_MAX = "MAX"
PEER_CARD_BTN_CONTACT_ROCKET = "Rocket.Chat"
PEER_CARD_SUBMISSION_PHOTO_TITLE = "🪪 <b>Модерация фото карточки</b>"
PEER_CARD_SUBMISSION_COMMENT_TITLE = "🪪 <b>Модерация комментария карточки</b>"
PEER_CARD_SUBMISSION_LOGIN = "🔑 <b>Логин:</b> <code>{login}</code>"
PEER_CARD_SUBMISSION_TG = "👤 <b>Telegram:</b> <a href='tg://user?id={tg_id}'>{name}</a>"
PEER_CARD_SUBMISSION_COMMENT = "💬 <b>Новый комментарий:</b> {comment}"
PEER_CARD_SUBMISSION_RULES = "📌 <b>Проверка:</b> только сам пир, без посторонних, лицо видно"
PEER_CARD_SUBMISSION_APPROVED_PHOTO = "✅ Фото карточки одобрено модератором."
PEER_CARD_SUBMISSION_APPROVED_COMMENT = "✅ Комментарий карточки одобрен модератором."
PEER_CARD_SUBMISSION_REJECTED = "❌ {kind} карточки отклонен{suffix}.\n<b>Причина:</b> {reason}"
PEER_CARD_SUBMISSION_PHOTO_KIND = "Фото"
PEER_CARD_SUBMISSION_COMMENT_KIND = "Комментарий"
PEER_CARD_SUBMISSION_REJECT_PHOTO_PROMPT = "Укажите причину отклонения фото или выберите шаблон."
PEER_CARD_SUBMISSION_REJECT_COMMENT_PROMPT = "Укажите причину отклонения комментария или выберите шаблон."
PEER_CARD_SUBMISSION_NOT_PENDING = "Заявка уже неактуальна."
PEER_CARD_SUBMISSION_BTN_APPROVE = "✅ Одобрить"
PEER_CARD_SUBMISSION_BTN_REJECT = "❌ Отклонить"
PEER_CARD_SUBMISSION_REASON_PHOTO_FACE = "Не видно лица"
PEER_CARD_SUBMISSION_REASON_PHOTO_OTHERS = "На фото есть посторонние"
PEER_CARD_SUBMISSION_REASON_COMMENT_SWEAR = "Мат"
PEER_CARD_SUBMISSION_REASON_COMMENT_RULES = "Не соответствует правилам Школы 21"
PEER_CARD_SUBMISSION_REASON_COMMENT_PERSONAL = "Личная информация"
