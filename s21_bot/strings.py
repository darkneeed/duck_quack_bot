...
PEER_CARD_PREVIEW_HEADER = "🪪 <b>Моя карточка</b>\nТак вас увидят другие участники:"
...
PEER_CARD_CONTACT_TELEGRAM = "📡 <b>Предпочитает связь:</b> <a href='tg://user?id={tg_id}'>Telegram</a>"
PEER_CARD_CONTACT_ROCKET = "📡 <b>Предпочитает связь:</b> Rocket.Chat — <code>{rocket}</code>"
PEER_CARD_CONTACT_MAX = "📡 <b>Предпочитает связь:</b> MAX"
PEER_CARD_CONTACT_NONE = "📡 <b>Предпочитает связь:</b> {contact}"
